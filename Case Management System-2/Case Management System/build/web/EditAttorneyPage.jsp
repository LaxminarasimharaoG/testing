...
<div class="container body-content" >
    ...
    <form action="AttorneyController?action=attorneyEditProfile" method="post" id="frm">
        <div class="col-sm-12" >
            ...
            <div>
                <input type="button" onclick="location.href='ViewAllAttorney.jsp'" class="btnStyle-1"value="Previous" style="width:80px" />
                <input type="button" onclick="location.href='AttorneyHome.jsp'" class="btnStyle-1" value="Home"style="width:80px" />
