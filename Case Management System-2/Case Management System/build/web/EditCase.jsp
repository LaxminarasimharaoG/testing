...
<%String msg = request.getParameter("msg");
                 if(msg != null){
                         if(msg.equals("edit-case-failure")){%>
                                 alert('Update Case Details Error');
                         <%}
                         %>
                <%} %>
...
<div class="container body-content">
    <div>
        <div class="left" ><h5> Edit Case Details </h5> </div>
    ...
    <br><br><br>
        ...
        <div id="casetype">
            <div class="form">
                <form action="CaseController?action=editCase" method="post" id="addCase">
                <div class="col-lg-12">
                   <div class="row">
                       <div class="col-sm-6 form-group" >
                           <input type="hidden" name="caseId" value="<%=caseDetails.getCaseId()%>">
                   ...
                   <div class="row">
                        ...
                        <div class="col-sm-6 form-group" >
                            ...
                            <input type="text" name="caseName" placeholder="Case Name" value="<%=caseDetails.getCaseName()%>" required="required"/>
                        </div>
                       <div class="col-sm-6 form-group" >
                            <label><font size="3" color="black">Status of Case</font> </label>
                            <input type="text" name="caseStatus" placeholder="Case Status" value="<%=caseDetails.getCaseStatus()%>" required="required"/>
                        </div> 
                   ...
                   <div class="row">
                        <div class="col-sm-6 form-group" >
                            ...
                            <input type="date" name="caseStartDate" value="<%=caseDetails.getCaseStartDate()%>" required="required"/>
                        </div>
                        <div class="col-sm-6 form-group" >
                            <label><font size="3" color="black"> Court Hearing</font> </label>
                            
                            <input type="date" name="caseHearing" value="<%=caseDetails.getCourtHearing()%>" required="required"/>
                        </div>
                   </div>
                   <div class="row">
                        <div class="col-sm-6 form-group" >
                            <label><font size="3" color="black">Mediator</font> </label>
                            <input type="text" name="mediator" placeholder="Mediator" value="<%=caseDetails.getMediator()%>" required="required"/>
                        </div> 
                       <div class="col-sm-6 form-group" >
                            <label><font size="3" color="black">Party 1</font> </label>
                            <input type="text" name="party1" placeholder="Party 1" value="<%=caseDetails.getParty1()%>" required="required"/>
                        </div>
                   </div>
                   <div class="row">
                        <div class="col-sm-6 form-group" >
                            <label><font size="3" color="black">Party 1</font> </label>
                            <input type="text" name="party2" placeholder="Party 2" value="<%=caseDetails.getParty2()%>" required="required"/>
                        </div> 
                       <div class="col-sm-6 form-group" >
                            <label><font size="3" color="black"> Notes </font></label>
                            <textarea rows="3" name="notes" placeholder="Notes" 
                                  required="required" cols="30" ><%=caseDetails.getCaseNotes()%></textarea>
                        </div>
                   </div>
                   <div class="row">
                        <div class="col-sm-6 form-group" >
                            ...
                            <textarea rows="3" name="actionTook" placeholder="Action Took" 
                                  required="required" cols="30" ><%=caseDetails.getActionTook()%></textarea>
                        </div> 
                       <div class="col-sm-6 form-group" >
                            ...
                            <textarea rows="3" name="actionNeedToTake" placeholder="Action Need To Take" 
                                  required="required" cols="30" ><%=caseDetails.getActionNeedToTake()%></textarea>
                        </div>
                   </div>
                    
                </div>
                   <div class="inputWrap" style="padding-left: 212px">
                        <button type="submit" class="loginBtnStyle" onclick="return validate()"  style="width:80px">Update</button>
                        <button type="button" class="loginBtnStyle" onclick="location.href='ViewCase.jsp'" 
