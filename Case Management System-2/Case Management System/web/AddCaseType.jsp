...
<%String msg = request.getParameter("msg");
                 if(msg != null){
                         if(msg.equals("add-case-type-failure")){%>
                                 alert('Case Type Added Error');
                         <%}
                         %>
                <%} %>
...
<%String msg1 = request.getParameter("msg");
                 if(msg1 != null){
                         if(msg1.equals("case-type-already-exist")){%>
                                 alert('Case Type Already Exist...Please Enter Different Case Type');
                         <%}
                         %>
                <%} %>
...
<div class="container body-content">
    <div>
        <div class="left" ><h5> Add Case Type </h5> </div>
    ...
    <br><br><br>
        ...
        <div id="casetype">
            <div class="form">
                <form action="CaseTypeController?action=addCaseType" method="post" id="addCaseType">
                    <div class="form-group" >
                        <label><font size="3" color="black"> Case Type</font> </label>
                        <input type="text" name="caseType" placeholder="Case type" required="required"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="inputWrap" style="padding-left: 170px">
                        ...
                        <button type="submit" class="loginBtnStyle" onclick="location.href='AttorneyHome.jsp'" 
