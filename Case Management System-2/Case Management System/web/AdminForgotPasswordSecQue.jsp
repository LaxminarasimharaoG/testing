...
<script type="text/javascript"> 
    ...
    <%String msg = request.getParameter("msg");
            if(msg != null){
                    if(msg.equals("admin-secqueans-failure")){%>
...
<h1> Admin Security Question</h1>

    <div class="rowalign">
        <%
            Admin currAdmin = (Admin)session.getAttribute("CurrAdmin");
	%>
	<form action="AdminController?action=adminForgotPassword" method="post">
            <div class="email">
                <label>Email Id </label>
                <input id="emailID" readonly style="width: 300px" value="<%=currAdmin.getEmailId()%>" name="emailId" class="form-control" type="text">					
            </div>
            <br>
            <div class="question">
                <label>Security Question </label>
                <input id="secque" readonly style="width: 300px" value="<%=currAdmin.getSecQue()%>" name="secQue" class="form-control" type="text">					
            </div>
            <br>
            <div class="answer">
                <label>Answer</label>
            ...
            <br>
            <div class="submit">
                <input type="button" onclick="location.href='AdminForgotPassword.jsp'" class="btnStyle"value="Previous" style="width:80px" />
