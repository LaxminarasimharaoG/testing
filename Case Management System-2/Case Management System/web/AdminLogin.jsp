    ...
    <script type="text/javascript"> 
        ...
        $("#updateDatabase").click(function(e)
        {
         ...
         <%String msg = request.getParameter("msg");
                 if(msg != null){
                         if(msg.equals("admin-login-failure")){%>
       ...
       <%String msg1 = request.getParameter("msg1");
            if(msg1 != null){
                    if(msg1.equals("admin-secqueans-success")){%>
        ...
        <%String msg2 = request.getParameter("msg");
                 if(msg2 != null){
                         if(msg2.equals("admin-reg-success")){%>
	...
	<!-- ADMIN -->
        <div class="adminLogin">
            <div id="admin">
                <div class="col-lg-12">
                    <div class="form">
                            <form action="AdminController?action=adminLoginCheck" method="post" id="frm" class="login-frm">
                                    ...
                                    <div class="form-group">
                                            <label><font size="3" color="black"> Password 1</font></label>
                                            <input type="password" placeholder="Password" name="priPassword" required="required"/>
                                    </div>
                                    <div class="form-group">
                                            <label><font size="3" color="black"> Password 2</font></label>
                                            <input type="password" placeholder="Password" name="SecPassword" required="required"/>
                                    </div>
                                    ...
                                    <div class="form-group" style="padding-left: 170px">                            										 
                                        <label id="forgotPwd"><a href="AdminForgotPassword.jsp"> <font size="3" color="red"> 
