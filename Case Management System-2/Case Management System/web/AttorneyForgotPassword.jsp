...
<script type="text/javascript"> 
    ...
    <%String msg = request.getParameter("msg");
            if(msg != null){
                    if(msg.equals("attorney-emailid-failure")){%>
...
<h1> Attorney Forgot Password </h1>

    <div class="rowalign">
	<form action="AttorneyController?action=attorneyForgotPasswordEmailCheck" method="post">
            ...
            <br>
            <div class="submit">
                 <input type="button" onclick="location.href='AttorneyLogin.jsp'" class="btnStyle"value="Previous" style="width:80px" />
