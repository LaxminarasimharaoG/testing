...
<div class="container body-content">
    <h1> Attorney Registration </h1>
    
    <form action="AttorneyController?action=attorneyRegister" method="post" id="frm">
	<div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-4 form-group">
                    ...
                    <select class="form-control input-sm" id="gender" name="yoe" >
            ...
            <div class="row">
                <div class="col-sm-4 form-group">
                    ...
                    <input type="text" placeholder="Enter Phone No Here.." name="contactno" pattern="[0-9]{1}[0-9]{9}" 
                           title="Phone number should be 10 digit" maxlength="10" class="form-control" required>
                </div>																			                                        
                <div class="col-sm-4 form-group">
            ...
            <div class="row">                                               											                                             
                <div class="col-sm-4 form-group">
                    ...
                    aria-describedby="name-format" title="Please enter the valid email id" required>
