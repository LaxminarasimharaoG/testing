...
<div class="container body-content">
    <div>
        <div class="left" ><h5> Update Client Details </h5> </div>
    ...
    <br><br><br>
        ...
        <div id="casetype">
            <div class="form">
                <form action="ClientController?action=editClient" method="post" id="addCaseType">
                    <div class="form-group" >
                        <input type="hidden" name="clientId" value="<%=client.getClientId()%>">
                        <label><font size="3" color="black">Client Name</font> </label>
                        <input type="text" name="clientName" placeholder="Client Name" value="<%=client.getClientName()%>" required="required"/>
                    </div>
                    <div class="form-group" >
                        <label><font size="3" color="black"> Email Id</font> </label>
                        <input type="email" name="clientEmailId" placeholder="Email Id" value="<%=client.getClientEmail()%>" required="required"/>
                    </div>
                    <div class="form-group" >
                        <label><font size="3" color="black"> Contact No</font> </label>
                        <input type="text" name="clientContactNo" placeholder="Contact No" value="<%=client.getClientContactNo()%>"
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="3" name="clientAddress" placeholder="Address" 
                                  required="required" cols="30" ><%=client.getClientAddress()%></textarea>
                    </div>
                    <div class="inputWrap" style="padding-left: 170px">
                        <button type="submit" class="loginBtnStyle" style="width:80px">Submit</button>
                        <button type="button" class="loginBtnStyle" onclick="location.href='ViewClient.jsp'" 
