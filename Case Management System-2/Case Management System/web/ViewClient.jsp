...
<%String msg = request.getParameter("msg");
                if(msg != null){
                    if(msg.equals("add-client-success")){%>
...
<%String msg1 = request.getParameter("msg1");
            if(msg1 != null){
                    if(msg1.equals("client-edit-success")){%>
...
<div>
    <div class="left" ><h5> View Clients </h5> </div>
            ...
            <c:forEach items="${clientList}" var="client">
                <tr>
                    ...
                    <select id="casetype" onchange="window.open(this.value,'_self');">
                            ...
                            <option value="EditClient.jsp?clientId=${client.getClientId()}">Edit</option>
                            <option value="ClientController?action=deleteClient&clientId=${client.getClientId()}">Delete</option>   
                    </select>
                    </td>
                </tr>
            </c:forEach>
